...
class HomingMovementPanel(BasePanel):
    def __init__(self, *args):
        ...
        self.notebook.InsertPage(1, flags_page, 'Properties')
        ...
        self.u_24 = self.add_single_selection_entry(flags_page, 'Affect by TimeScale (?)', choices={
            'No': 0x0,
            'Yes': 0x1
        })

        self.speed_modifier = self.add_float_entry(self.entry_page, 'Speed Modifier / Frame Duration')
        self.u_10 = self.add_num_entry(self.entry_page, 'Frame Threshold')
